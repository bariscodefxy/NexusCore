...
namespace NexusCore\Core\Entities;

use Evenement\EventEmitter;
use NexusCore\API\Coordinates3D;
use NexusCore\Core\Networking\Packets\DestroyEntityPacket;
use NexusCore\Core\Networking\Packets\EntityMetadataPacket;
use NexusCore\Core\Networking\Packets\EntityTeleportPacket;
use NexusCore\Core\Networking\Packets\EntityVelocityPacket;
use NexusCore\Core\Physics\PhysicsEngine;
